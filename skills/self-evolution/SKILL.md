...
self-evolution - "Production-grade autonomous self-improvement system with research-backed meta-learning, safe self-modification, and continuous optimization. Based on AI safety research (MIRI, DeepMind, OpenAI) and meta-learning principles. Enables endless evolution cycles with safety constraints."

### 使用方法

此 Skill 已安装到 `/home/node/.openclaw/workspace/skills/self-evolution/`
...
```bash
# 查看帮助
cd /home/node/.openclaw/workspace/skills/self-evolution
cat SKILL.md
