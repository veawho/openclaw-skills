...
agent-autonomy-kit-automaton - Stop waiting for prompts. Keep working. - Automaton Edition

### 使用方法

此 Skill 已安装到 `/home/node/.openclaw/workspace/skills/agent-autonomy-kit-automaton/`
...
```bash
# 查看帮助
cd /home/node/.openclaw/workspace/skills/agent-autonomy-kit-automaton
cat SKILL.md
