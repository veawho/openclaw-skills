...
此 Skill 已安装到 `/home/node/.openclaw/workspace/skills/documentation/`
...
```bash
# 查看帮助
cd /home/node/.openclaw/workspace/skills/documentation
cat SKILL.md
...
## OVERVIEW_PLACEHOLDER ## Structure Hierarchy
