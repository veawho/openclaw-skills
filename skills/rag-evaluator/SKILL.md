...
Ragaai Catalyst - "Python SDK for Agent AI Observability, Monitoring and Evaluation Framework. Includes features like a ragaai catalyst, python, agentic-ai."

### 使用方法

此 Skill 已安装到 `/home/node/.openclaw/workspace/skills/rag-evaluator/`
...
```bash
# 查看帮助
cd /home/node/.openclaw/workspace/skills/rag-evaluator
cat SKILL.md
