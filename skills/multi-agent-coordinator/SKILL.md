...
multi-agent-coordinator - Coordinate multiple AI agents to complete complex tasks together.

### 使用方法

此 Skill 已安装到 `/home/node/.openclaw/workspace/skills/multi-agent-coordinator/`
...
```bash
# 查看帮助
cd /home/node/.openclaw/workspace/skills/multi-agent-coordinator
cat SKILL.md
