...
description_zh: Mnge Apple Reminders 通过 'remindctl' 命令行接口 on mcOS （list, dd, edit, complete, delete）. Supp或ts lists, dte filters, 和 JSON/plin output.。
...
此 Skill 已安装到 `/home/node/.openclaw/workspace/skills/apple-reminders/`
...
```bash
# 查看帮助
cd /home/node/.openclaw/workspace/skills/apple-reminders
cat SKILL.md
