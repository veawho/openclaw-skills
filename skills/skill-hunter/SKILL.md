...
skill-hunter - "Find, evaluate, and install ClawHub skills. Semantic search across 10,000+ skills, security vetting before install, side-by-side comparison. The skill that makes skills useful."

### 使用方法

此 Skill 已安装到 `/home/node/.openclaw/workspace/skills/skill-hunter/`
...
```bash
# 查看帮助
cd /home/node/.openclaw/workspace/skills/skill-hunter
cat SKILL.md
