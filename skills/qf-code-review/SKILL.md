...
qf-code-review - Systematic code review framework for security, performance, and best practices.

### 使用方法

此 Skill 已安装到 `/home/node/.openclaw/workspace/skills/qf-code-review/`
...
```bash
# 查看帮助
cd /home/node/.openclaw/workspace/skills/qf-code-review
cat SKILL.md
