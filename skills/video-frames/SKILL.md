...
此 Skill 已安装到 `/home/node/.openclaw/workspace/skills/video-frames/`
...
```bash
# 查看帮助
cd /home/node/.openclaw/workspace/skills/video-frames
cat SKILL.md
...
- Extract frames or short clips from videos

## OVERVIEW_PLACEHOLDER ## Quick start
