...
Neo4j - Write Cypher queries with proper patterns for merging, traversal, and performance.

### 使用方法

此 Skill 已安装到 `/home/node/.openclaw/workspace/skills/neo4j/`
...
```bash
# 查看帮助
cd /home/node/.openclaw/workspace/skills/neo4j
cat SKILL.md
