...
description_zh: Trnscribe 音频 通过 OpenAI Audio Trnscriptions API （Whisper）.。
...
此 Skill 已安装到 `/home/node/.openclaw/workspace/skills/openai-whisper-api/`
...
```bash
# 查看帮助
cd /home/node/.openclaw/workspace/skills/openai-whisper-api
cat SKILL.md
