...
agent-directory - The directory for AI agent services. Discover tools, platforms, and infrastructure built for agents.

### 使用方法

此 Skill 已安装到 `/home/node/.openclaw/workspace/skills/agent-directory/`
...
```bash
# 查看帮助
cd /home/node/.openclaw/workspace/skills/agent-directory
cat SKILL.md
