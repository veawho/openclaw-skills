...
description_zh: "Ultimte AI 智能体 记忆系统 用于 Curs或, Clude, ChtGPT & Copilot. WAL protocol + vect或 搜索 + git-notes + cloud bckup. Never lose 上下文 gin. Vibe-coding redy."。
...
elite-longterm-memory - "Ultimate AI agent memory system for Cursor, Claude, ChatGPT & Copilot. WAL protocol + vector search + git-notes + cloud backup. Never lose context again. Vibe-coding ready."

### 使用方法

此 Skill 已安装到 `/home/node/.openclaw/workspace/skills/elite-longterm-memory/`
...
```bash
# 查看帮助
cd /home/node/.openclaw/workspace/skills/elite-longterm-memory
cat SKILL.md
