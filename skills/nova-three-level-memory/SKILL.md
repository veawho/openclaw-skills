...
description: |
  AI Agent 三层记忆架构系统。用于构建具有长期记忆能力的 AI 助手。
...
此 Skill 已安装到 `/home/node/.openclaw/workspace/skills/nova-three-level-memory/`
...
```bash
# 查看帮助
cd /home/node/.openclaw/workspace/skills/nova-three-level-memory
cat SKILL.md
