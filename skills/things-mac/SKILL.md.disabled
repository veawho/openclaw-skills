...
things-mac - Manage Things 3 via the `things` CLI on macOS (add/update projects+todos via URL scheme; read/search/list from the local Things database). Use when a user asks Clawdbot to add a task to Things, list inbox/today/upcoming, search tasks, or inspect projects/areas/tags.

### 使用方法

此 Skill 已安装到 `/home/node/.openclaw/workspace/skills/things-mac/`
...
```bash
# 查看帮助
cd /home/node/.openclaw/workspace/skills/things-mac
cat SKILL.md
