...
shared-pinecone-rag - Use the shared Pinecone RAG index for any agent in this workspace. Use when an agent needs to ingest markdown/text docs into pulse-rag or query semantic context from the shared index.

### 使用方法

此 Skill 已安装到 `/home/node/.openclaw/workspace/skills/shared-pinecone-rag/`
...
```bash
# 查看帮助
cd /home/node/.openclaw/workspace/skills/shared-pinecone-rag
cat SKILL.md
